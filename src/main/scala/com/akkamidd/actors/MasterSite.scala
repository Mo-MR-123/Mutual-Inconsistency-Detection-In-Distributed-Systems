...
object MasterSite {
  ...
  def apply(): Behavior[MainMessage] =
    Behaviors.setup { context =>
      ...
      // update files
      siteA ! Site.FileUpdate(MurmurHash3.stringHash("A" + time_a1), "A")
      siteA ! Site.FileUpdate(MurmurHash3.stringHash("A" + time_a2), "A")
      siteB ! Site.FileUpdate(MurmurHash3.stringHash("B" + time_b1), "B")
